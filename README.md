...
## What Consulting-as-Code™ Is Not
- Not a chatbot  
...
- `/whitepaper` → Canonical argument & category definition
- `/architecture` → System design & reasoning model
- `/agents` → Agent roles & responsibilities
- `/audits` → Stress tests that break humans and LLMs
- `/diagrams` → Visual system references
- `/meta` → Evaluation frameworks & terminology
