...
It is built on a **neuro-symbolic system** that explicitly separates:
- Understanding
- Reasoning
- Enforcement
...
Neural systems are used **only** where they excel:
- Listening to transcripts
- Extracting signals
...
This architecture:
- Refuses illegal solutions
- Rejects bad math
- Surfaces true constraints
- Produces auditable logic
